...
namespace QuizTower.IDP.Pages.ExternalLogin;
...
public class Callback : PageModel
{
    ...
    public async Task<IActionResult> OnGet()
    {
        ...
        var isuser = new IdentityServerUser(user?.Subject ?? providerUserId)
        {
            DisplayName = user?.UserName ?? providerUserId,
        ...
        // 
        await _events.RaiseAsync(new UserLoginSuccessEvent(provider, providerUserId, user?.Subject ?? providerUserId, user?.UserName ?? providerUserId, true, context?.Client.ClientId));
